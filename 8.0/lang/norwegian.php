...
$_LANG['store']['ssl']['cartTitle'] = "Beskytt din side med SSL";
$_LANG['store']['ssl']['cartShortDescription'] = "Legg til SSL til ditt webhotell for å¨gi dine besøkende tryggehet i at din nettside er sikker. Dette bygger også tillit.";
...
$_LANG['store']['ssl']['promo']['sidebar']['title'] = "Legg SSL til din nettside";
$_LANG['store']['ssl']['promo']['sidebar']['body'] = "Aktiver hengelåsikonet og beskytt personvernet til dine besøkende";
...
$_LANG['store']['ssl']['shared']['oneYear'] = "1 år";
$_LANG['store']['ssl']['shared']['twoYears'] = "2 år";
...
$_LANG['store']['ssl']['landingPage']['certTypeInfo'] = "<a href=\":dvLink\">Standard SSL (Domenevalidert)</a> sertifikater er de enkleste og mest vanlige typen SSL sertifikater. <a href=\":ovLink\">OV</a> og <a href=\":evLink\">EV sertifikater</a> autentiserer også identiteten til bedriften eller organisasjonen som eier sertifikatet. Dette gjør det tryggere for de besøkende på nettsiden.";
