...
$_LANG['store']['ssl']['shared']['oneYear'] = "1 An";
$_LANG['store']['ssl']['shared']['twoYears'] = "2 Ans";
...
$_LANG['store']['ssl']['landingPage']['certTypeInfo'] = "<a href=\":dvLink\">Les certificats SSL standards (DV)</a> sont le type de certificat SSL le plus simple et le plus courant. Les certificats <a href=\":ovLink\">Validation de l'organisation (OV)</a> et <a href=\":evLink\">Validation étendue (EV)</a> authentifient également l'identité de l'entreprise ou de l'organisation détentrice du certificat, offrant ainsi une plus grande confiance aux utilisateurs finaux.";
