...
$_LANG['store']['ssl']['shared']['oneYear'] = "שנה אחת";
$_LANG['store']['ssl']['shared']['twoYears'] = "שנתיים";
...
$_LANG['store']['ssl']['landingPage']['certTypeInfo'] = "<a href=\":dvLink\"> תעודות SSL עם אימות ברמת הדומיין </a> הן תעודות ההצפנה הפשוטות והנפוצות ביותר. <a href=\":ovLink\"> תעודת SSL עם אימות ברמת הארגון / חברה</a> ו <a href=\":evLink\"> תעודת SSL עם אימות מורחב</a> גם מאמתות את הזהות של החברה / הארגון שמחזיק בתעודה ובכך מגבירות את האמון של הגולשים באתר.";
