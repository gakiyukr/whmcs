    ...
    <div class="row client-summary-panels">
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="clientssummarybox">
                ...
                <ul>
                    <li><a id="summary-login-as-client" href="#"><img src="images/icons/clientlogin.png" border="0" align="absmiddle" /> {$_ADMINLANG.clientsummary.loginasclient}</a></li>
                </ul>
            </div>
...
<form method="post" action="{routePath('admin-client-login', $clientsdetails.id)}" id="frmLoginAsClient"></form>

<script>
    $(document).ready(function() {
        $('#summary-login-as-client').click(function(e) {
            e.preventDefault();
            $('#frmLoginAsClient').submit();
        });
    });
</script>
