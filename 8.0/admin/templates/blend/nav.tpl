...
<div class="navbar-collapse">
    <ul>
        ...
        <li class="has-dropdown">
            <a id="Menu-Clients"{if in_array("List Clients",$admin_perms)} href="clients.php"{/if}>
        ...
        <li class="has-dropdown">
            <a id="Menu-Orders"{if in_array("View Orders",$admin_perms)} href="orders.php"{/if}>
        ...
        <li class="has-dropdown">
            <a id="Menu-Billing"{if in_array("List Transactions",$admin_perms)} href="transactions.php"{/if}>
        ...
        <li class="has-dropdown">
            <a id="Menu-Support"{if in_array("Support Center Overview",$admin_perms)} href="supportcenter.php"{/if}>
    ...
    <ul class="right-nav">
        ...
        {/if}
        <li class="bt has-dropdown">
            <a id="Menu-Setup"href="{routePath('admin-setup-index')}" title="{$_ADMINLANG.setup.config}">
                ...
                {if in_array("Configure General Settings",$admin_perms)}
                    <li>
                        <a id="Menu-Config-Setup" href="{routePath('admin-setup-index')}">
                            <span class="ico-container"><i class="fad fa-cogs"></i></span>
        ...
        <li class="account has-dropdown">
            <a id="Menu-Account" href="#">
                ...
                <span class="">{$_ADMINLANG.account}</span>
                <span class="caret"></span>
            </a>
            <ul class="slim">
        ...
        <li class="right-nav has-dropdown">
            <a id="Menu-Help" href="#">
                <i class="far fa-question-circle always"></i>
                {$_ADMINLANG.help.title}
                <span class="caret"></span>
            </a>
            <ul class="drop-left">
